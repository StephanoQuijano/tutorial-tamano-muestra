...
subtitle: "Tutorial práctico con el paquete `pwr` para investigación en salud"
...
install.packages("pwr2")   # ANOVA de dos vías
```
...
# Escenario 10: encuestas para estimar una proporción
